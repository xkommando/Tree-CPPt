...
#define __ASER_TREE_UPDATE_LOCK 1
//#undef __ASER_TREE_UPDATE_LOCK
...
void MutexLock(ThreadState *thr, uptr pc, uptr addr, int rec, bool try_lock) {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __ASER_TREE_UPDATE_LOCK
  u64 lockId = s->GetId();
  lockId <<= kTidBits;
  thr->tctx->threadHistory.PushBack(static_cast<u32>(lockId));
  thr->sNotUpdated_ = false;
#endif
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int MutexUnlock(ThreadState *thr, uptr pc, uptr addr, bool all) {
  ...
  u64 lockId = s->GetId();
  lockId <<= kTidBits;
  thr->tctx->threadHistory.Remove(static_cast<u32>(lockId));
  thr->sNotUpdated_ = false;
#endif
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
