...
#define __ASER_TREE_UPDATE 1
//#undef __ASER_TREE_UPDATE
...
//  _M_Printf("\r\n\r\n>>>>!!!!!!!   caller_thr=%p  this->thr=%p\r\n", caller_thr, this->thr);
//  if (caller_thr != nullptr)
//    _M_Printf("\r\n>>>>!!!!!!! current=%d     %d (caller)  JOIN   %d (this)      caller history size=%d \r\n",
//              curThr->tid,
//              caller_thr->tid, this->tid, caller_thr->tctx->threadHistory.Size());
#ifdef __ASER_TREE_UPDATE
  caller_thr->tctx->threadHistory.PushBack(~this->tid);
#endif
//  thr->tctx->sNotUpdated_ = false;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void ThreadContext::OnStarted(void *arg) {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __ASER_TREE_UPDATE
  u32 ptid = this->parent_tid;
  if (ptid != 0) {
    ThreadContext *pctx = (ThreadContext *) __tsan::ctx->thread_registry->threads_[ptid];
    this->threadHistory.PushBack(pctx->threadHistory);
  }
  threadHistory.PushBack(ptid);
#endif
//  thr->tctx->sNotUpdated_ = false;
  /////////////////////////////////////////////////////////////////////////////////////////////////
