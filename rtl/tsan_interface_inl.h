...
void _M_tsan_read4(void *addr, u64 idx) {
  MemoryRead(cur_thread(), CALLERPC, (uptr)addr, kSizeLog4, idx);
}

void _M_tsan_write4(void *addr, u64 idx) {
  MemoryWrite(cur_thread(), CALLERPC, (uptr)addr, kSizeLog4, idx);
}
