...
void ALWAYS_INLINE MemoryRead(ThreadState *thr, uptr pc,
    uptr addr, int kAccessSizeLog, u64 idx) {
MemoryAccess(thr, pc, addr, kAccessSizeLog, false, false, idx);
}
...
void ALWAYS_INLINE MemoryWrite(ThreadState *thr, uptr pc,
    uptr addr, int kAccessSizeLog, u64 idx) {
MemoryAccess(thr, pc, addr, kAccessSizeLog, true, false, idx);
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
